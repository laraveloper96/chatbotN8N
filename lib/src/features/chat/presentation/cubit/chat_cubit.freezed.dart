...
mixin _$ChatState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<MessageEntity> messages) loading,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<MessageEntity> messages)? loading,
...
class _$LoadingImpl implements _Loading {
  const _$LoadingImpl({required final List<MessageEntity> messages})
      : _messages = messages;
...
abstract class _Loading implements ChatState {
  const factory _Loading({required final List<MessageEntity> messages}) =
      _$LoadingImpl;
...
class _$ErrorImpl implements _Error {
  const _$ErrorImpl(
      {required this.message, required final List<MessageEntity> messages})
      : _messages = messages;
...
abstract class _Error implements ChatState {
  const factory _Error(
      ...
      required final List<MessageEntity> messages}) = _$ErrorImpl;
