...
abstract class $MessageEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String content, bool isFromUser, DateTime timestamp});
}
...
class _$MessageEntityImpl implements _MessageEntity {
  ...
  @override
  String toString() {
    return 'MessageEntity(id: $id, content: $content, isFromUser: $isFromUser, timestamp: $timestamp)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, content, isFromUser, timestamp);
